...
class ChatNav extends React.Component {
    ...
    render(){
        return <>
            <div className="flex flex-row fixed z-10 shadow-lg top-0 w-full h-16 items-center justify-between bg-white">
                <button className="px-2" onClick={this.props.ToggleDisplay}><img src={returnIcon}/></button>
