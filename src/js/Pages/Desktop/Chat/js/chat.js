...
class Chat extends React.Component {
    ...
    componentDidMount() {
        ...
        this.getMessages();
        let page = document.getElementById("page-chat");
        page.addEventListener("wheel", this.listScroll);
        page.addEventListener("resize",this.scrollCalculate);
    }
    ...
    render() {
        return  <>
        <Page id="page-chat" className="flex-1"> 
            {this.userDialog && <UserAddDialog close={this.closeAddUser}/>}
            <ChatNav openAddUser={this.openAddUser}/>
            <div className="w-full h-screen overflow-hidden bg-custom-blue-100">
