...
class MessageInput extends React.Component {
    ...
    render(){
        return <>
            <div className="absolute bottom-0 pb-2 z-20 h-16 w-full backdrop-blur">
                <div className="flex flex-row bg-white w-5/6 h-14 mx-auto px-6 py-2 rounded-3xl items-center justify-between shadow-xl border-solid border border-custom-blue-500 border-opacity-20 ">
